...
async function exportSelectedProductionReport(): Promise<void> {
  ...
  const { createProductionReportMarkdown } = await loadProductionResourceExports();
...
async function exportSelectedProductionReportSceneCsv(): Promise<void> {
  ...
  const exportedAt = new Date().toISOString();
  const manifest = buildProductionCallSheetManifest(source.callSheet, source.breakdown);
  const { createProductionReportSceneCsv } = await loadProductionResourceExports();
...
async function exportSelectedProductionLocation(): Promise<void> {
  ...
  const exportedAt = new Date().toISOString();
  const { createProductionLocationMarkdown } = await loadProductionResourceExports();
...
async function exportSelectedProductionTalent(): Promise<void> {
  ...
  const exportedAt = new Date().toISOString();
  const { createProductionTalentMarkdown } = await loadProductionResourceExports();
...
async function exportProductionShots(format: "markdown" | "csv"): Promise<void> {
  ...
  const { createProductionShotCsv, createProductionShotMarkdown } = await loadProductionResourceExports();
...
function loadProductionDocumentExports() {
  return import("./production-document-export");
}

function loadProductionResourceExports() {
  return import("./production-resource-export");
}
...
async function exportSelectedCallSheet(): Promise<void> {
  ...
  const manifest = productionCallSheet && source
    ...
    : null;
  const { createCallSheetMarkdown } = await loadProductionDocumentExports();
...
async function exportSelectedProductionSides(format: "markdown" | "html"): Promise<void> {
  ...
  const { createProductionSidesHtml, createProductionSidesMarkdown } = await loadProductionDocumentExports();
...
async function exportSelectedScreenplayElementReport(format: "markdown" | "csv"): Promise<void> {
  ...
  const { createScreenplayElementReportCsv, createScreenplayElementReportMarkdown } = await loadScreenplayReviewExports();
...
async function exportSelectedScreenplayRevisionReport(): Promise<void> {
  ...
  const exportedAt = new Date().toISOString();
  const { createScreenplayRevisionMarkdown } = await loadScreenplayReviewExports();
