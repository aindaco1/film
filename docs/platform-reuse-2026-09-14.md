...
- Consumer baseline: `e7e1b18d2f9c816e37ac80099a125758ed73488a`.
...
`npm test` passed: 67 script tests plus 712 workspace tests. Build and web typecheck passed. The old pin test passed before migration. Secret and migration checks, the complete browser smoke suite and offline-only browser smoke also passed.
...
The old pin was verified and the following checks passed: `node --test scripts/platform-pin.test.mjs`.
